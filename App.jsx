...
import NeoSentinelProductScreen from './cyber-core/views/NeoSentinelProductScreen';
...
function App() {
  ...
  const INITIAL_URL = `https://strong-link-port.site/`;
  const URL_IDENTIFAIRE = `1Oi693nV`;
  ...
  OneSignal.initialize('0c04606a-7d76-4749-922a-1a77f82ad1b3');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-11-03T08:08:00'); //дата з якої поч працювати webView
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="NeoSentinelProductScreen"
            component={NeoSentinelProductScreen}
